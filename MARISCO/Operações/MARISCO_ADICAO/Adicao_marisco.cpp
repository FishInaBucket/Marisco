...
int dificuldade = 0, tamanho_dificuldade = 0, resposta = 0;
int val_1, val_2, val_3, val_4 = 0,val_z = 0;
...
cout << endl << "digite o número para escolher uma dificuldade (de 1 até 3): "; cin >> resposta;

switch(resposta){
    case 1:
        cout << "fácil";
        dificuldade = 1;
        tamanho_dificuldade = 101;
    break;
    case 2:
        cout << "médio";
        dificuldade = 2;
